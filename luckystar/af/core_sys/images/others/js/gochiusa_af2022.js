const dialogue = {
  ...
  home: {
    ...
    negative: [
      {
        chara: "elu",
        txt: ["はぁ…上手く話しかけれない", "仲良くなれるかもしれないのに…"],
        voice: "05_Elu.mp3",
      },
      {
        chara: "natsume",
        txt: ["青い鳥を見つけたらお別れだし", "仲良くしても寂しいだけだよ"],
  ...
  comics: [
    ...
    [
      {
        chara: "elu",
        text: ["ラビットハウスのみんなに教えたらどんな反応するかな", "夢の話"],
        voice: "17_Elu.mp3",
      },
      {
        chara: "natsume",
        text: ["変な顔されないかな", "みんな小さな天使になってたとか"],
...
for (let i = 1; i <= 6; i++) {
  ...
  for (let x = 0; x < gameImgName.length; x++) {
    ...
    gameImg[imgNum + x].src =
      "core_sys/images/main/game/" + imgNum + "_" + gameImgName[x];
  }
}
...
for (let i = 0; i < specialCharaName.length; i++) {
  ...
  specialCharaImg[specialCharaName[i]].src =
    specialImgDir + specialCharaName[i] + specialCharaImgType[0];
  specialCharaEggImg[specialCharaName[i]] = new Image();
  specialCharaEggImg[specialCharaName[i]].src =
    specialImgDir + specialCharaName[i] + specialCharaImgType[1];
}
...
const tags = {
  ...
  // loading:
  //   '<div class="loading__wrap"><div class="loading__inner"><div class="loading__logo"><ul><li><img src="' +
  //   loadingImg[0].src +
  //   '"></li><li><img src="' +
  //   loadingImg[1].src +
  //   '"></li><li><img src="' +
  //   loadingImg[2].src +
  //   '"></li></ul><p>PRESENTS</p></div><div class="loading__txt"></div></div></div>',
  loading: `
...
`,
  home:
    ...
    "					<li>" +
    '						<button type="button" data-type="weixin" onclick="window.location.href=\'https://mp.weixin.qq.com/s/kumyIhB0_Oy49YaL9p0Rlw\'">' +
    "							<span>DETAIL</span>" +
    '							<img src="' +
    homeImg[1].src +
    '">' +
  ...
  story:
    ...
    '		<div class="story__bg"><span><img src="' +
    storyImg[0].src +
    '"></span></div>' +
    '		<div class="story__main">' +
    '			<div class="story__txt">' +
    '				<span class="blue">女の人</span>と<span class="blue">女の人</span>が話しています。<br>これから、誰が誰に<span class="blue">チョコ</span>をあげるつもりですか？' +
    "			</div>" +
    ...
    storyImg[2].src +
    '"></dt>' +
    "					<dd>よく「お金で愛は買えない」とか言うけどさ、ある意味でバレンタインチョコってお金で愛を表してるよね</dd>" +
    "				</dl>" +
    '				<dl class="story__dialogue-left">' +
    '					<dt><img src="' +
    storyImg[3].src +
    '"></dt>' +
    "					<dd>ゲームでしか恋愛したことない奴は言うことがシビアだな</dd>" +
    "				</dl>" +
    '				<dl class="story__dialogue-right">' +
    '					<dt><img src="' +
    storyImg[2].src +
    '"></dt>' +
    "					<dd>まぁ、ゲームだと、当日よりそれまでにどれだけ好感度アップするかが大事なんだよね</dd>" +
    "				</dl>" +
    '				<dl class="story__dialogue-left">' +
    '					<dt><img src="' +
    storyImg[3].src +
    '"></dt>' +
    "					<dd>ん～私は別にバレンタインって言っても、変わったことないわよ。男子も夢見すぎ</dd>" +
    "				</dl>" +
    '				<dl class="story__dialogue-right">' +
    '					<dt><img src="' +
    storyImg[2].src +
    '"></dt>' +
    "					<dd>皆鏡フラグを立てられなかったんだね</dd>" +
    "				</dl>" +
    '				<dl class="story__dialogue-left">' +
    '					<dt><img src="' +
    storyImg[3].src +
    '"></dt>' +
    "					<dd>そういうの、あんたはなんかあるんの？</dd>" +
    "				</dl>" +
    '				<dl class="story__dialogue-right">' +
    '					<dt><img src="' +
    storyImg[2].src +
    ...
    storyImg[3].src +
    '"></dt>' +
    "					<dd>はいはい、ゲームの中でしょ？フラグとか好感度とか言ってるあんたの将来が時々本気で心配になるわよ。本当にゲーム中のイベントだけってどうなの？</dd>" +
    "				</dl>" +
    '				<dl class="story__dialogue-right">' +
    '					<dt><img src="' +
    storyImg[2].src +
    '"></dt>' +
    "					<dd>（嘆く）知りもしないで偏見だけで話す人は嫌だ嫌だ</dd>" +
    "				</dl>" +
    '				<dl class="story__dialogue-left">' +
    '					<dt><img src="' +
    storyImg[3].src +
    ...
    storyImg[2].src +
    '"></dt>' +
    "					<dd>最近はゲーム内時間でも、短期間で終わるのが多いから、バレンタインは掠りもしないことは多いんだよ。</dd>" +
    "				</dl>" +
    '				<dl class="story__dialogue-left">' +
    '					<dt><img src="' +
    storyImg[3].src +
    ...
    storyImg[2].src +
    '"></dt>' +
    "					<dd>でも、今年はちゃんと人にチョコあげる予定とかあるんだよ</dd>" +
    "				</dl>" +
    '				<dl class="story__dialogue-left">' +
    '					<dt><img src="' +
    storyImg[3].src +
    ...
    storyImg[2].src +
    '"></dt>' +
    "					<dd>うん～（首を上下に振る）同じオンラインゲームやってる人にね。</dd>" +
    "				</dl>" +
    '				<dl class="story__dialogue-left">' +
    '					<dt><img src="' +
    storyImg[3].src +
    ...
    storyImg[2].src +
    '"></dt>' +
    "					<dd>うんん（否定）、実際にあったりするわけじゃないけどね</dd>" +
    "				</dl>" +
    '				<dl class="story__dialogue-left">' +
    '					<dt><img src="' +
    storyImg[3].src +
    ...
    storyImg[2].src +
    '"></dt>' +
    "					<dd>ゲーム内でキャラとしてチョコ渡すんだよ。一応中身人間だし</dd>" +
    "				</dl>" +
    '				<dl class="story__dialogue-left">' +
    '					<dt><img src="' +
    storyImg[3].src +
    '"></dt>' +
    "					<dd>ちゃんと「人に」って言うのか？それ…</dd>" +
    "				</dl>" +
    '				<dl class="story__dialogue-left">' +
    '					<dt><img src="' +
    storyImg[3].src +
    '"></dt>' +
    "					<dd>結局ただのゲームキャラじゃないのよ</dd>" +
    "				</dl>" +
    '				<dl class="story__dialogue-right">' +
    '					<dt><img src="' +
    storyImg[2].src +
    ...
    storyImg[2].src +
    '"></dt>' +
    "					<dd>うん、ゲーム内で結婚してて、私は男キャラだから</dd>" +
    "				</dl>" +
    '				<dl class="story__dialogue-left">' +
    '					<dt><img src="' +
    storyImg[3].src +
    '"></dt>' +
    "					<dd>ちょっと待って、って男が女にチョコあげるのか？というか、女が女にあげてるようなもんでしょ？相手女の人なら</dd>" +
    "				</dl>" +
    '				<dl class="story__dialogue-right">' +
    '					<dt><img src="' +
    storyImg[2].src +
    '"></dt>' +
    "					<dd>大～丈夫！相手の中身は男だから</dd>" +
    "				</dl>" +
    '				<dl class="story__dialogue-left">' +
    '					<dt><img src="' +
    storyImg[3].src +
    ...
    storyImg[3].src +
    '"></dt>' +
    "					<dd>あ～まぁ、こういうのは各個人が楽しめればいいのよね</dd>" +
    "				</dl>" +
    '				<dl class="story__dialogue-right">' +
    '					<dt><img src="' +
    storyImg[2].src +
    ...
    '			<div class="story__txt">' +
    '				これから、誰が誰に<span class="blue">チョコ</span>をあげるつもりですか？<br>' +
    "			</div>" +

    
    // https://mp.weixin.qq.com/s/kumyIhB0_Oy49YaL9p0Rlw
    ...
    // https://mp.weixin.qq.com/s/kumyIhB0_Oy49YaL9p0Rlw
    '			<div class="story__button">' +
    '				<button type="button" data-type="home" onclick="window.location.href=\'https://mp.weixin.qq.com/s/kumyIhB0_Oy49YaL9p0Rlw\'">' +
    '					<img src="' +
    homeImg[1].src +
    '">' +
    '					<span>Get more info...<br>Go!</span>' +
    '				</button>' +
    '			</div>' +
    ...
    "</div>",
  start: [
    '<div class="start"><div class="start__inner"><div class="start__bg"><span><img src="' +
      startImg[0].src +
      '"></span></div><div class="start__main"><div class="start__txt">扉の先には　青い鳥の卵があるそうです<br>卵を見つけ　青い鳥を孵化させましょう</div><div class="start__list"><ul>',
    '</ul></div><div class="start__button"><button type="button" data-type="home"><img src="' +
      homeImg[1].src +
      '"><span>START</span></button></div></div></div></div>',
  ],
  startList: [
    "森のパン屋さん",
    "思い出の大都会",
  ...
  house: [
    '<div class="house"><div class="house__inner"><div class="house__bg"><span><img src="' +
      storyImg[0].src +
      '"></span></div><div class="house__main"><div class="house__head">見つけた鳥を確認できます</div><div class="house__list"><ul>',
    '</ul></div><div class="house__button"><button type="button" class="house__button-bird"><div class="house__button-ph"><img src="' +
      houseImg[9].src +
      '"></div><div class="house__button-cap">最近よく来る鳥です<br>気にしないでください</div></button><button type="button" class="house__button-door" data-type="start"><div class="house__button-ph"><img src="' +
      homeImg[1].src +
      '"></div><div class="house__button-cap">出掛ける</div></button></div></div></div></div>',
  ],
  chara:
    '<div class="chara"><div class="chara__inner"><div class="chara__img"><img src=""></div><div class="chara__txt"><div class="chara__comment"></div><div class="chara__head"><div class="chara__name"><div class="chara__name-egg"><img src=""></div><div class="chara__name-name"></div></div><div class="chara__head-ph"><img src=""></div></div><div class="chara__dialogue"><ul><li class="chara__dialogue-elu"><div class="chara__dialogue-txt"></div></li><li class="chara__dialogue-natsume"><div class="chara__dialogue-txt"></div></li></ul></div><div class="chara__button"><button type="button" class="chara__button-dl"><div class="house__button-ph"><img src="core_sys/images/main/chara/dl.png"></div><div class="house__button-cap">写真を撮る</div></button><button type="button" class="chara__button-door" data-stage="07"><div class="house__button-ph"><img src="core_sys/images/main/start/door7.png"></div><div class="house__button-cap">部屋を出る</div></button></div></div></div></div>',
  comics:
    '<div class="comics"><div class="comics__inner"><div class="comics__ph"><img src="core_sys/images/main/game/ed.png" ></div><div class="comics__dialogue"><ul><li class="comics__dialogue-elu"><div class="comics__dialogue-name">エル</div><div class="comics__dialogue-txt"></div></li><li class="comics__dialogue-natsume"><div class="comics__dialogue-name">ナツメ</div><div class="comics__dialogue-txt"></div></li></ul></div></div></div>',
  fakeAds:
    '<div class="fakeAds"><div class="fakeAds__inner"><img src="' +
    comicsImg[7].src +
    '"></div></div>',
  special:
    '<div class="special"><div class="special__inner"><div class="special__bg"><span><img src="' +
    specialImg[0].src +
    '"></span></div><div class="special__main"><ul class="special__imgs"><li><div class="special__head"></div><div class="special__ph"><a href="#" download><img src="#" alt=""></a></div></li><li><div class="special__head"></div><div class="special__ph"><a href="#" download><img src="#" alt=""></a></div></li></ul><div class="special__button"><button type="button" class="special__button-home"><div class="special__button-ph"><img src="' +
    homeImg[1].src +
    '"></div><div class="special__button-cap">部屋を出る</div></button></div></div></div></div>',
};
const stageTxt = {
  game: {
    "01": {
  ...
  clear: {
    "01": {
      name: "ここあ",
      comment:
        "生まれたてのおねえちゃんだよ！<br>おねえちゃんにまかせなさーい！",
      dialogue: [
        "わぁ、この子パンの香りがするよ！",
        "でも、パンと幸せの過剰摂取でお腹いっぱいだよ…",
      ],
      result:
        "持ち帰った卵は青い鳥ではなかった<br>※ここあを自宅で確認できるようになりました",
    },
    "02": {
      name: "めぐ",
      comment:
        "わぁっ、これは風邪っぽいですねー。<br>しんぞういしょくしなければ！術式開始です！",
      dialogue: [
        "ナツメちゃんの心臓に何かあったら私ドナーになるから！",
        "エルはどうなるの？",
      ],
      result:
        "持ち帰った卵は青い鳥ではなかった<br>※めぐを自宅で確認できるようになりました",
    },
    "03": {
      name: "ちや",
      comment: "つぶあん派？こしあん派？<br>わたしはあまうさあん派―♪",
      dialogue: ["わたしはミックス派！", "なんか羊羹パン食べたくなってきた…"],
      result:
        "持ち帰った卵は青い鳥ではなかった<br>※ちやを自宅で確認できるようになりました",
    },
    "04": {
      name: "しゃろ",
      ...
      result:
        "持ち帰った卵は青い鳥ではなかった<br>※しゃろを自宅で確認できるようになりました",
    },
    "05": {
      name: "まや",
      comment:
        "なんだよーその目はー！<br>ペンギンだって立派なちょーるいだぞー！",
      dialogue: [
        "ペンギンなのに、背中に羽が生えてるー♪",
        "すごい、水陸空両用じゃん。",
      ],
      result:
        "持ち帰った卵は青い鳥ではなかった<br>※まやを自宅で確認できるようになりました",
    },
    "06": {
      name: "りぜ",
      comment:
        "生きのこるのは悪いやつばかりだ。<br>りぜは…悪い子だ…こっそりケーキつまみ食いした。",
      dialogue: ["やはり生き残るには…悪になるしか…", "なんかの映画のセリフ？"],
      result:
        "持ち帰った卵は青い鳥ではなかった<br>※りぜを自宅で確認できるようになりました",
    },
    "07": {
      name: "ちの",
      comment:
        "この白いもふもふは親友のてぃっぴー。<br>まつ毛がちゃーむぽいんとっておじいちゃんが言ってた。",
      dialogue: [
        "なんかずっと飲みたかったコーヒーの香りがするー。",
        "将来、うちの専属バリスタになってくれないかなー。",
      ],
      result:
        "持ち帰った卵は青い鳥ではなかった<br>※ちのを自宅で確認できるようになりました",
    },
    "08": {
      name: "ふゆ",
      comment: "………とり…好き？<br>「まぁ吾輩が好きなのは猫だがね」",
      dialogue: ["え、服の猫で腹話術？すごい！", "もっとやってやって！"],
      result:
        "持ち帰った卵は青い鳥ではなかった<br>※ふゆを自宅で確認できるようになりました",
    },
  },
  ending: [
    {
    ...
    {
      natsume:
        "私たちも世界を知れてよかった。<br>見方とか感じ方変わった気がする。",
